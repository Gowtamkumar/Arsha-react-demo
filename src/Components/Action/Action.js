...
const Action = () => {
    return (
        <section class="action-contaienr">
        <div class="container">
            <div class="row" data-aos="zoom-in">
                ...
                <div class="col-md-3 d-fex align-items-center justify-content-end mt-5">
                    <button type="button" class="btn rounded-pill text-light "
                        style={{}}>
